...
// Redireccion de salida + anexar: abre el fichero de salida alternativo a la consola, donde se anexan los resultados de ejecución.
...
{
       0,     0,     3,     7,    12,    14,    17,    21,    22,    27,
      28,    31,    32,    35,    38,    41,    42,    48,    49
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      14,     0,    -1,    15,    16,    12,    -1,    15,    16,     9,
      12,    -1,    12,    -1,     5,    18,    -1,     5,    18,    19,
      -1,    -1,    10,    17,    15,    16,    -1,    -1,     5,    18,
      -1,    -1,     6,     5,    -1,     7,     5,    -1,     8,     5,
      -1,    -1,     6,     5,    20,     7,     5,    -1,    -1,     7,
       5,    21,     6,     5,    -1
};
...
{
       0,   212,   212,   213,   214,   217,   217,   219,   219,   219,
     221,   221,   224,   225,   226,   227,   227,   228,   228
};
#endif
...
{
  "$end", "error", "$undefined", "NAME", "NUMBER", "COMANDO", "ENTRADA",
  "SALIDA", "APPEND", "BACKGROUND", "TUBERIA", "PCOMA", "SALTO_DE_LINEA",
  "$accept", "sentencia", "CMD", "PIPE", "$@1", "ARG", "REDIR", "$@2",
  "$@3", 0
};
#endif
...
{
       0,    13,    14,    14,    14,    15,    15,    17,    16,    16,
      18,    18,    19,    19,    19,    20,    19,    21,    19
};
...
{
       0,    11,     4,     0,     9,    11,     5,     1,     7,     0,
      10,     0,     0,     0,     6,     0,     0,     2,    12,    13,
      14,     9,     3,     0,     0,     8,     0,     0,    16,    18
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,     4,     9,    15,     6,    14,    23,    24
};
...
{
      -5,    -3,    -9,     3,    -4,    -3,     2,    -9,    -9,    -8,
      -9,     0,     6,     7,    -9,     8,     4,    -9,    10,     9,
      -9,    -4,    -9,    11,    13,    -9,    15,    16,    -9,    -9
};
...
{
       1,    16,     5,     7,    17,    18,     8,     2,    11,    12,
      13,    19,    20,     1,    21,   -17,    22,   -15,    26,    27,
      28,    29,    25,    10
};

static const yytype_uint8 yycheck[] =
{
       5,     9,     5,     0,    12,     5,    10,    12,     6,     7,
       8,     5,     5,     5,    15,     6,    12,     7,     7,     6,
       5,     5,    21,     5
};
...
{
       0,     5,    12,    14,    15,     5,    18,     0,    10,    16,
      18,     6,     7,     8,    19,    17,     9,    12,     5,     5,
       5,    15,    12,    20,    21,    16,     7,     6,     5,     5
};
